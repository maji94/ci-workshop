...
function _page($total_row, $per_page, $uri_segment, $url) {
	...
	$config['num_tag_open'] = '<li class="paginate_button page-item"><div class="page-link">';
	$config['num_tag_close']= '</div></li>';
	$config['prev_link'] 	= '&lt;';
	$config['prev_tag_open']='<li class="paginate_button page-item previous disabled"><div class"page-link">';
	$config['prev_tag_close']='</div></li>';
	$config['next_link'] 	= '&gt;';
	$config['next_tag_open']='<li class="paginate_button page-item next disabled"><div class"page-link">';
